...
public class DocumentBenchmarking {
	...
	public static void main(String[] args) {
		...
		// The text to test on
		String textfile = "src/main/resources/data/warAndPeace.txt";
		...
		// and prints out timing results as described in the assignment instructions.
		for (int numToCheck = start; numToCheck < numSteps * increment + start; numToCheck += increment) {
			...
			long finishBasic = System.nanoTime();
			System.out.print(((finishBasic-startBasic)/1000000000d) + "\t");
			...
			long finishEfficient = System.nanoTime();
			System.out.println(((finishEfficient-startEfficient)/1000000000d) + "\t");
		}
