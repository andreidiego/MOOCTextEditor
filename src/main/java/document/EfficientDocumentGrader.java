...
public class EfficientDocumentGrader {
    public static void main(String[] args) {
        try
        {
            ...
            BufferedReader br = new BufferedReader(new FileReader("src/test/resources/test_cases/mod2TestCases.txt"));
            String line;
            PrintWriter out = new PrintWriter("src/main/resources/grader_output/module2.part1.out", "utf-8");
